...
<body ng-app='movieApp'>
    ...
    <div class="container-fluid bg_container" ng-controller="MovieDetailsCtrl as movie" style="background-image:url('https://image.tmdb.org/t/p/original/{{movie.images.backdrops[0].file_path}}');">

        <div class="container">
            <input type="hidden" value="<?php echo $id;?>" id="movie_id">
            <div class="row">
                <div class="col-sm-5">
